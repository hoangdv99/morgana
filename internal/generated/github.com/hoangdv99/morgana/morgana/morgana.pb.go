...
const file_api_morgana_proto_rawDesc = "" +
	"\n" +
	"\x11api/morgana.proto\x12\amorgana\"2\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\"\xd1\x01\n" +
	"\fDownloadTask\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12!\n" +
	"\x04user\x18\x02 \x01(\v2\r.morgana.UserR\x04user\x12:\n" +
	"\rdownload_type\x18\x03 \x01(\x0e2\x15.morgana.DownloadTypeR\fdownloadType\x12\x10\n" +
	"\x03url\x18\x04 \x01(\tR\x03url\x12@\n" +
	"\x0fdownload_status\x18\x05 \x01(\x0e2\x17.morgana.DownloadStatusR\x0edownloadStatus\"N\n" +
	...
	"\rdownload_type\x18\x02 \x01(\x0e2\x15.morgana.DownloadTypeR\fdownloadType\x12\x10\n" +
	"\x03url\x18\x03 \x01(\tR\x03url\"X\n" +
	"\x1aCreateDownloadTaskResponse\x12:\n" +
	"\rdownload_task\x18\x01 \x01(\v2\x15.morgana.DownloadTaskR\fdownloadTask\"`\n" +
	"\x1aGetDownloadTaskListRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x04R\x05limit\x12\x16\n" +
	"\x06offset\x18\x03 \x01(\x04R\x06offset\"\x9b\x01\n" +
	"\x1bGetDownloadTaskListResponse\x12C\n" +
	"\x12download_task_list\x18\x01 \x03(\v2\x15.morgana.DownloadTaskR\x10downloadTaskList\x127\n" +
	"\x18toal_download_task_count\x18\x02 \x01(\x04R\x15toalDownloadTaskCount\"m\n" +
	...
	"\rdownload_task\x18\x01 \x01(\v2\x15.morgana.DownloadTaskR\fdownloadTask\"1\n" +
	...
	"\aSuccess\x10\x042\xa1\x05\n" +
	"\x0eMorganaService\x12P\n" +
	"\rCreateAccount\x12\x1d.morgana.CreateAccountRequest\x1a\x1e.morgana.CreateAccountResponse\"\x00\x12P\n" +
	"\rCreateSession\x12\x1d.morgana.CreateSessionRequest\x1a\x1e.morgana.CreateSessionResponse\"\x00\x12_\n" +
	"\x12CreateDownloadTask\x12\".morgana.CreateDownloadTaskRequest\x1a#.morgana.CreateDownloadTaskResponse\"\x00\x12b\n" +
	"\x13GetDownloadTaskList\x12#.morgana.GetDownloadTaskListRequest\x1a$.morgana.GetDownloadTaskListResponse\"\x00\x12_\n" +
	"\x12UpdateDownloadTask\x12\".morgana.UpdateDownloadTaskRequest\x1a#.morgana.UpdateDownloadTaskResponse\"\x00\x12_\n" +
	"\x12DeleteDownloadTask\x12\".morgana.DeleteDownloadTaskRequest\x1a#.morgana.DeleteDownloadTaskResponse\"\x00\x12d\n" +
	"\x13GetDownloadTaskFile\x12#.morgana.GetDownloadTaskFileRequest\x1a$.morgana.GetDownloadTaskFileResponse\"\x000\x01B&Z$github.com/hoangdv99/morgana/morganab\x06proto3"

var (
	file_api_morgana_proto_rawDescOnce sync.Once
	file_api_morgana_proto_rawDescData []byte
)

func file_api_morgana_proto_rawDescGZIP() []byte {
	file_api_morgana_proto_rawDescOnce.Do(func() {
		file_api_morgana_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_morgana_proto_rawDesc), len(file_api_morgana_proto_rawDesc)))
	})
...
var file_api_morgana_proto_goTypes = []any{
...
func file_api_morgana_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_morgana_proto_rawDesc), len(file_api_morgana_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
